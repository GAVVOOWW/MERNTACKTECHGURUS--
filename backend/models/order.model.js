...
const OrderSchema = new mongoose.Schema({
    ...
    paymentStatus: {
        type: String,
        enum: ['Pending Downpayment', 'Downpaid', 'Pending Full Payment', 'Fully Paid', 'Refunded'],
    ...
    balancePaymentSessionId: { type: String }, // For tracking balance payment sessions
    paidAmount: { type: Number, default: 0 }, // Track total amount paid so far
}, { timestamps: true });
